...
from ace_step.ace_models.attention import LinearTransformerBlock, t2i_modulate
from ace_step.ace_models.lyrics_utils.lyric_encoder import ConformerEncoder as LyricEncoder
